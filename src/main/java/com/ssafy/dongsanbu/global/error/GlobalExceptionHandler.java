package com.ssafy.dongsanbu.global.error;

import com.ssafy.dongsanbu.global.error.response.ErrorResponse;
...
@RestControllerAdvice(basePackages = {"com.ssafy.dongsanbu"})
@Slf4j
